...
function main(argv) {
    ...
    if (cmd === "validate") {
        ...
        console.log(`OK  scan=${model.scan} system=${model.system.id} elements=${model.components.length +
    ...
    if (cmd === "export") {
        ...
        if (format === "png") {
            console.error("PNG export from CLI is not available in Node. Use: scan export svg <file> -o out.svg");
            process.exit(1);
        }
